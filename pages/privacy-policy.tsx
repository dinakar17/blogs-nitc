...
const PrivacyPolicy = () => {
  return (
    <div className="prose prose-indigo prose-base w-[90%] mx-auto md:w-[60%] dark:prose-invert">
      ...
      <p>Privacy Policy for this NITC Website</p>
      <p>
        At NITC, accessible from{" "}
        ...
        and recorded by NITC and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in NITC. This policy is not applicable to any
      ...
      <p>
        NITC follows a standard procedure of using log files. These files log
        visitors when they visit websites. All hosting companies do this and are
      ...
      <p>
        ...
        demographic information. Our Privacy Policy was created with the help of
        the Privacy Policy Generator and the Disclaimer Generator.
      </p>
      ...
      <p>
        ...
        advertising partners of NITC.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on NITC, which are sent directly to
      ...
      <p>
        Note that NITC has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>
      <h3>Third Party Privacy Policies</h3>
      <p>
        NITC’s Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        NITC does not knowingly collect any Personal Identifiable Information
